...
D_REF = {
    ("Au", "Au"): 2.609, #if suing relative to Cu-Cu must be 2.609   .... the ref of au-au is 2.980
    #("Au", "Pd"): 2.8975,
    #("Pd", "Pd"): 2.815,
    ("Cu", "Cu"): 2.609,
    ("Au", "Cu"): 2.609#2.7945,    #if suing relative to Cu-Cu must be 2.609   .... the ref bridge as a average of au-au and cu-cu bond is 2.7945
}
